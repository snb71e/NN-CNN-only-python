...
OUT_DIR  = "epoch_500_outputs_torch_NN"
os.makedirs(OUT_DIR, exist_ok=True)

CKPT_PATH = os.path.join(CKPT_DIR, "epoch_500_torch_nn.pt")
HIST_PATH = os.path.join(CKPT_DIR, "epoch_500_torch_nn_loss_history.json")
...
model = ThreeLayerNN(input_size=28*28, hidden_size1=128, hidden_size2=64, output_size=10).to(device)
...
plt.title("Torch NN Confusion Matrix (Probability)")
